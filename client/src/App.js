    ...
    return (
        <div>
            <BrowserRouter>
                ...
                <div className="sm:mx-[7%] flex">
                    <div className="hidden sm:flex flex-col w-2/6 space-y-3 z-20">
                        <div className="hidden sm:block w-auto rounded-none sm:rounded-md px-4 py-5 ml-30 w-2/6 mt-0 sm:mt-[-30px] bg-white text-black z-20">
                    ...
                    <div className="rounded-none sm:rounded-md mx-[3px] sm:ml-[20px] px-4 py-5 w-full mt-0 sm:mt-[-30px] bg-white h-full text-black z-20">
                        <Routes>
